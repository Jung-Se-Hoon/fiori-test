		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori CDS OData List",
									"targetURL": "#zc518cds0001fioricds01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zc518cds0001fioricds01-display": {
								"semanticObject": "zc518cds0001fioricds01",
								"action": "display",
								"description": "Fiori OData with CDS View",
								"title": "Fiori CDS OData List",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zc518.cds0001.fioricds01",
									"url": sap.ui.require.toUrl("zc518/cds0001/fioricds01")
								}
							}
						}
					}
