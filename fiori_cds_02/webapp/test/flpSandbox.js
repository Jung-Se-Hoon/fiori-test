		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Airline Total Chart",
									"targetURL": "#zc518cds0002fioricds02-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zc518cds0002fioricds02-display": {
								"semanticObject": "zc518cds0002fioricds02",
								"action": "display",
								"description": "Airline Total Chart",
								"title": "Airline Total Chart",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zc518.cds0002.fioricds02",
									"url": sap.ui.require.toUrl("zc518/cds0002/fioricds02")
								}
							}
						}
					}
