		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori CRUD Training",
									"targetURL": "#zc518gw0001fioricrud01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zc518gw0001fioricrud01-display": {
								"semanticObject": "zc518gw0001fioricrud01",
								"action": "display",
								"description": "Fiori CRUD Training",
								"title": "Fiori CRUD Training",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zc518.gw0001.fioricrud01",
									"url": sap.ui.require.toUrl("zc518/gw0001/fioricrud01")
								}
							}
						}
					}
