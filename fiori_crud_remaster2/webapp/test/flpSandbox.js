		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori_CRUD Remaster",
									"targetURL": "#zc518gw0003fioricrudremaster2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zc518gw0003fioricrudremaster2-display": {
								"semanticObject": "zc518gw0003fioricrudremaster2",
								"action": "display",
								"description": "Fiori CRUD Remaster",
								"title": "Fiori_CRUD Remaster",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zc518.gw0003.fioricrudremaster2",
									"url": sap.ui.require.toUrl("zc518/gw0003/fioricrudremaster2")
								}
							}
						}
					}
