		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "List, Table, Chart",
									"targetURL": "#zc518gw0003fiorilistchart-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zc518gw0003fiorilistchart-display": {
								"semanticObject": "zc518gw0003fiorilistchart",
								"action": "display",
								"description": "List, Table, Chart",
								"title": "List, Table, Chart",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zc518.gw0003.fiorilistchart",
									"url": sap.ui.require.toUrl("zc518/gw0003/fiorilistchart")
								}
							}
						}
					}
